...
# Known hard-coded test values
expect Crc32.checksum([]) == 0x00000000
expect Crc32.checksum("The quick brown fox jumps over the lazy dog".to_utf8()) == 0x414FA339
expect Crc32.checksum("123456789".to_utf8()) == 0xCBF43926
expect Crc32.checksum([0x00]) == 0xD202EF8D
expect Crc32.checksum([0xFF]) == 0xFF000000
expect Crc32.checksum([0x61]) == 0xE8B7BE43
expect Crc32.checksum([0x00, 0x00, 0x00, 0x00]) == 0x2144DF1C
expect Crc32.checksum([0xFF, 0xFF, 0xFF, 0xFF]) == 0xFFFFFFFF
...
# with the stated polynomial by regenerating entry [1] (0x77073096) from 0xEDB88320.
expect {
	polynomial : U32
